...
<br>
        ...
        <div class="form-group">
            ...
            <input type="text" id="nom" name="nom" placeholder="Entrer votre prenom" required>
        </div>
        
        <div class="form-group">
            <label for="email">Mot de Passe</label>
            <input type="password" id="email" name="email" placeholder="veuiller entrer votre e-mail" required>
        </div>
